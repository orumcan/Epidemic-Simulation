...
public class WorldMapView {
 ...
 public void initializeView(Country[][] countries, ActionListener actionListener) {
	 ...
	 JLabel infoLabel = new JLabel("ID Country IsAlive IsInfected IsSick InfectionDay  MoveDay ");
	...
	scrollPane = new JScrollPane(consolePanel, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
